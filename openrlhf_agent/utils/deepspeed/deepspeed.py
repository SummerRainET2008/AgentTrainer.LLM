...
from openrlhf_agent.models import Actor
from openrlhf_agent.models.ring_attn_utils import get_ring_attn_group, set_ring_attn_group
from openrlhf_agent.utils.distributed_sampler import DistributedSampler
from openrlhf_agent.utils.distributed_util import torch_dist_barrier_and_cuda_sync
...
class DeepspeedStrategy(ABC):
    ...
    def setup_ring_attn(self, ds_device_mesh):
        ...
        from openrlhf_agent.models.ring_attn_utils import patch_transformers_for_ring_flash_attn
