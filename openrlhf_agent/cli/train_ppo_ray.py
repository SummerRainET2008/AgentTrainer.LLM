...
from openrlhf_agent.trainer.ray import create_vllm_engines
from openrlhf_agent.trainer.ray.launcher import (
    RayActorGroup,
    ReferenceModelActor,
    RewardModelActor,
)
from openrlhf_agent.trainer.ray.ppo_actor import PolicyModelActor
from openrlhf_agent.trainer.ray.ppo_critic import CriticModelActor
from openrlhf_agent.utils import get_strategy
...
def train(args):
    ...
    if args.train.async_enable:
        from openrlhf_agent.trainer.ppo_trainer_async import PPOTrainerAsync as PPOTrainer
    else:
        from openrlhf_agent.trainer.ppo_trainer import PPOTrainer
...
if __name__ == "__main__":
    ...
    from openrlhf_agent.utils.config import hierarchize
